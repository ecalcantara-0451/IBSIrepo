...
curl -H "Agent-Version-Control: on" -L $MANAGERURL/software/agent/${runningPlatform}${majorVersion}/${archType}/$package?tenantID=3231 -o /tmp/$package $CURLOPTIONS
...
/opt/ds_agent/dsa_control -a $ACTIVATIONURL "tenantID:C904AA4A-9207-2CB2-71A6-97165A088989" "token:0012496E-3AF1-18B6-3F2B-6197311ED9F3" "policyid:67"
# /opt/ds_agent/dsa_control -a dsm://agents.workload.sg-1.cloudone.trendmicro.com:443/ "tenantID:C904AA4A-9207-2CB2-71A6-97165A088989" "token:0012496E-3AF1-18B6-3F2B-6197311ED9F3" "policyid:35"